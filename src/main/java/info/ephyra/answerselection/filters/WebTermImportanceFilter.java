...
//		lastTargetTermCounters = termCounters;
	...
	public static void main(String[] args) {
		...
		if (!OpenNLP.createTokenizer("resources/nlp/tokenizer/opennlp/EnglishTok.bin.gz"))
			MsgPrinter.printErrorMsg("Could not create tokenizer.");
//		LingPipe.createTokenizer();
		
		// create sentence detector
//		MsgPrinter.printStatusMsg("Creating sentence detector...");
//		if (!OpenNLP.createSentenceDetector("resources/nlp/sentencedetector/opennlp/EnglishSD.bin.gz"))
