...
public class AnswerTypesComparison {
	...
	public static void main(String[] args) {
		...
		File hierarchyFile =
			new File("../Ephyra/resources/answertypes/typesystem/ephyra.types");
		try {
		...
		File patternFile = new File("../Ephyra/resources/nlp/netagger/patterns.lst");
		try {
		...
		// - list-based taggers
		File[] listFiles =
			FileUtils.getFiles("../Ephyra/resources/nlp/netagger/lists/");
